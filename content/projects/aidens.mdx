...
A [live demo page](/labs/aidens-closed-loop) shows the system in action with real metrics, captured facts, and the comparison table against other systems.