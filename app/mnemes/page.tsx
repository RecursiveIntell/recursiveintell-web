...
export const metadata: Metadata = pageMetadata("/mnemes", {
  ...
  openGraph: {
    ...
    description:
      "Self-hosted agent memory for one device or every device you authorize.",
    url: "/mnemes",
    siteName: "Mnemes",
    type: "website",
    images: [
      {
        ...
        width: 1200,
        height: 630,
        alt: "Mnemes local-first agent memory",
      },
    ],
  },
  twitter: {
    ...
    title: "Mnemes — Memory, With a Witness",
    description:
      "Self-hosted agent memory with temporal state, provenance, and receipts.",
