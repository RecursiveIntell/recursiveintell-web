          ...
          <div className="mt-8 flex flex-wrap gap-3">
            {Object.entries(frontmatter.links).map(([label, url]) => (
              <a
                ...
                className="inline-flex items-center gap-2 rounded-lg border border-[color:var(--color-border)] bg-white px-4 py-2 text-sm font-medium text-[color:var(--color-text)] transition-colors hover:bg-gray-50 hover:border-[color:var(--color-accent)]"
              >
