...
export const metadata: Metadata = {
  ...
  description:
    "Josh Stevenson builds Rust-first local evidence runtimes, memory systems, claim hygiene tools, and operator-control software.",
  keywords: [
    "Josh Stevenson",
    "Rust engineer",
    "portfolio",
  ...
  openGraph: {
    ...
    description:
      "Rust-first local evidence runtimes, memory systems, claim hygiene tools, and operator-control software.",
    images: [
      {
  ...
  twitter: {
    ...
    title: "recursiveintell · Josh Stevenson",
    description:
      "Rust-first evidence runtimes, local memory, and ClaimLedger-backed claim hygiene.",
